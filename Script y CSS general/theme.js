...
$(document).ready(function () {
	...
	switch (curLang) {
		...
		case 'es':
			$.extend(true, $.magnificPopup.defaults, {
				...
				gallery: {
					tPrev: 'Imagen Anterior de la GalerÃ­a (Tecla de flecha a la izquierda)', // Alt text on left arrow
					tNext: 'Imagen Siguiente de la GalerÃ­a (Tecla de flecha a la derecha)', // Alt text on right arrow
		...
		case 'ca':
			$.extend(true, $.magnificPopup.defaults, {
				...
				gallery: {
					...
					tNext: 'Imatge SegÃ¼ent de la Galeria (Tecla de fletxa ala dreta)', // Alt text on right arrow
					tCounter: '%curr% de %total%' // Markup for "1 of 7" counter
				},
				image: {
	...
	// para que los enlaces con ancla especiales nos lleven con animacion al bloque correspondiente de la pÃ¡gina
	...
	// PPARA DETECTAR LAS IMÃGENES CON ENLACE Y QUE NO INCLUYAN EL ICONO VECTORIAL EN EL :BEFORE
